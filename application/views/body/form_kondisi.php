							...
							<div class="col-md-6">
								<form method="post" action="<?php echo base_url();?><?php echo $url;?>">
									...
									<div class="form-group">
										...
										<input class="form-control" name="nama_kondisi" value="<?php echo $nama_kondisi;?>"
											placeholder="Nama Kondisi" required>
									</div>

									<div class="form-group">
										<label>Waktu Respon (Hari)</label>
										<input class="form-control" name="waktu_respon" value="<?php echo $waktu_respon;?>"
											placeholder="Waktu Respon" required>
									</div>
